...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XLabs.Platform.Services.Geolocation.GeolocationContinuousListener, XLabs.Platform.Droid", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener ()
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("XLabs.Platform.Services.Geolocation.GeolocationContinuousListener, XLabs.Platform.Droid", "", this, new java.lang.Object[] {  });
	}
