...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XLabs.Platform.Device.Gyroscope, XLabs.Platform.Droid", Gyroscope.class, __md_methods);
	}
	...
	public Gyroscope ()
	{
		...
		if (getClass () == Gyroscope.class)
			mono.android.TypeManager.Activate ("XLabs.Platform.Device.Gyroscope, XLabs.Platform.Droid", "", this, new java.lang.Object[] {  });
	}
